...
$pbsinglePostBgColor = get_sub_field('pbpost_bg_color');
$pbpanel_padding = get_sub_field('pbpanel_padding');
$pbpanel_margin = get_sub_field('pbpanel_margin');
$pbcontentPosition = get_sub_field('pbcontent_position');
$panelBgImagePosition = get_sub_field('panel_bg_image_position');
$pbcontentWidth = (int)get_sub_field('pbcontent_width');
...
$pbpost_object = get_sub_field('pbselect_your_post');
$pblink_text = get_sub_field('pbread_more_link_text');
if( $pbpost_object ):
$post = $pbpost_object;
setup_postdata( $post );
if($pbcontentPosition == "left") {
$pbpostBgImage = "background-image: url(" . wp_get_attachment_url( get_post_thumbnail_id($post->ID)) .")";
$panel_bg_image_size = get_sub_field('panel_bg_image_size');
...
echo '<div class="single-post-panel ' . $pbpanel_padding . ' ' . $pbpanel_margin . ' background ' . $panel_bg_image_size . '" style="' . $pbpostBgImage . $pbsinglePostBgColor . '">';
  ...
  echo '<div class="single-post-panel ' . $pbpanel_padding . ' ' . $pbpanel_margin . ' background ' . $panel_bg_image_size . '" style="' . $pbsinglePostBgColor . '">';
    ...
    $pbpanel_full_width = get_sub_field('pbpanel_full_width');
    $pbtext_color = get_sub_field('pbtext_color');
